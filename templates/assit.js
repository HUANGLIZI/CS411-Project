...
const errorMessage = 'By clicking the tab on the left of nav bar, you can check out the houses and users';
const errorMessage1 = 'By clicking the tab on the right, you can search for related houses and more';
